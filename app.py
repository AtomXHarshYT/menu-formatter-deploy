...
def ask_gemini(prompt_text):
    ...
    prompt = f"""
You are a professional menu parser. First, clean the following text by removing all special characters like #, @, $, %, &, *, (, ), etc. — only keep letters, numbers, spaces, and punctuation that is useful (like commas, periods, hyphens in prices or names). Convert double quotes (\") into single quotes (').
